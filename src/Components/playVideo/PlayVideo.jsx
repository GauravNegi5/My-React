...
const PlayVideo = ({videoId}) => {
    ...
    const fetchVideoData = async () => {
        try {
            ...
            console.log("Fetching from:", videoDetails_url);
            ...
            if (data.items && data.items.length > 0) {
                ...
                console.warn("No video data found. Check if videoId is correct and API Key is valid.");
            }
        } catch (error) {
  ...
  return (
    <div className="play-video">
        ...
        <iframe  src={`https://www.youtube.com/embed/${videoId}?autoplay=1`}  frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  allowFullScreen
